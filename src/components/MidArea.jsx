  ...
  return (
    <div className={`flex-1 h-[90vh] overflow-y-auto  p-2 `}>
      <div className="flex flex-wrap gap-4 items-center mb-[2.25rem]">
        <h1
          className={`mt-4 header font-poppins text-2xl font-semibold mb-4  ${
            activeView === "midarea" && "bg-green-500 p-3 border-gray-300 rounded-md text-white"
          }`}
          onClick={() => {
        ...
        <h1
          className={`mt-4 header font-poppins text-2xl font-semibold mb-4 ${
            ...
            "bg-green-500 p-3 border-gray-300 rounded-md text-white"
          }`}
          onClick={() => {
        ...
        <h1
          className={`font-poppins text-[1.1rem] font-semibold cursor-pointer flex items-center gap-3 border-4 border-teal-500 p-2 rounded-md $`}
          onClick={() => {
            dispatch(addList());
          }}
        >
        ...
        <h1
          className={`font-poppins text-[1.1rem] font-semibold cursor-pointer flex items-center gap-3 border-4 border-blue-500 p-2 rounded-md select-none ${
        ...
        >
          Action of click of Sprite {thisSprite}
        </h1>
      </div>
